...
export default function PrivacyPolicy() {
  return (
    <main className="max-w-2xl mx-auto py-16 px-4 text-gray-800 mt-16">
      ...
      <p className="mb-4">If you have any questions about this Privacy Policy or your data, please use our <a href="/contact?type=other" className="text-blue-600 underline">contact form</a>.</p>
      <h2 className="text-xl font-bold mt-6 mb-2">Updates</h2>
